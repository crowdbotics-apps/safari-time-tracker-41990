...
## Project Structure
    ...
    ├── safari_time_tracker_41990  # Django project configurations
...
1. Clone this repo and `cd safari_time_tracker_41990`
...
2. Clone this repo and `cd safari_time_tracker_41990`
